...
allAccommodation = \
    [thing for thing in things if (thing.__class__ == House or thing.__class__ == Flat)] #TASK 5.3.(c)  -- replace [] by a list comprehension
...
houseFloorsSequence = \
    [accom.floors for accom in allAccommodation if accom.__class__ == House] # TASK 5.3.(b)  -- replace [] by a list comprehension
